...
urlpatterns = [
    ...
    path('login', LoginView.as_view(template_name='vehicle/login.html'),name='customerlogin'),
    path('login', LoginView.as_view(template_name='vehicle/login.html'),name='mechaniclogin'),
    path('login', LoginView.as_view(template_name='vehicle/login.html'),name='adminlogin'),
